...
export default function CheckoutPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const orderData = {
        _type: "order",
        customer: user.fullName || "Anonymous",
    ...
    <div className="min-h-screen pt-[115px] lg:pt-0 bg-white">
      ...
      >
        ...
        <div className="max-w-[1320px] mx-auto px-[20px] lg:px-[60px] flex flex-col justify-center items-center text-white text-center py-16">
          <p className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">CheckOut</p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex items-center">
              ...
              <a href="/checkout" className="ml-2 text-xl sm:text-2xl md:text-3xl text-[#FF9F0D]">
                Checkout
              </a>
            </div>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between pt-4 md:flex-row flex-col">
              <Link href="/cart" className="py-2 border border-gray-300 rounded-md text-sm font-medium w-72 text-black">
                Back to cart
              </Link>
              <button onClick={handleCheckout} className="px-6 py-2 bg-orange-500 text-white rounded-md text-sm font-medium w-72">
                Checkout
              </button>
            </div>
          </div>
